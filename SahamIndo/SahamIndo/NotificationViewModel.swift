...
final class NotificationViewModel: ObservableObject {
    ...
    // Major IDX symbols monitored for sentiment signals
    ...
    /// Fetch latest sentiment from the database and create alerts for strong signals.
    /// Rate-limited to once per hour; always runs if no prior check exists.
    func checkForAlerts() async {
        ...
        // Symbols already alerted today — skip to avoid duplicates
